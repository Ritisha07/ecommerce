...
@section('main-container')
    ...
    <div class="container">
        <div class="cart-section wishlist-section">
                    ...
                    <tbody>
                        ...
                        @foreach ($wishlistItems as $item)
                            <tr class="table-row ticket-row">
                                ...
                                <td class="table-wrapper">
                                    <div class="table-wrapper-center">
                                    <a href="{{ route('wishlist.remove', $item->id) }}" class="remove-btn" title="Remove from Wishlist">
            ...
            <a href="{{ route('wishlist.removeAll') }}" class="clean-btn" 
            onclick="return confirm('Are you sure you want to remove all items?')">Clean Wishlist</a>
            <a href="cart" class="shop-btn">View Cart</a>
            </div>
        </div>
    </div>
</section>
