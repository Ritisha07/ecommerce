...
@section('main-container')
    ...
    <section id="hero" class="hero">
        <div class="swiper hero-swiper" >
            <div class="swiper-wrapper hero-wrapper" style="height: 100%">
                <!-- Slide One -->
                <div class="swiper-slide" style="height: 100%; background-image: url('{{ asset('images/hero_image.png') }}');">
                    <div class="container">
                        <div class="col-lg-6">
        ...
        <div class="container">
            ...
            <div class="brand-section">
                ...
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="{{route('product-sidebar')}}">
                            <img src="{{asset('frontend/assets/images/homepage-one/brand-img-4.webp')}}" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="{{route('product-sidebar')}}">
                            <img src="{{asset('frontend/assets/images/homepage-one/brand-img-5.webp')}}" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="{{route('product-sidebar')}}">
                            <img src="{{asset('frontend/assets/images/homepage-one/brand-img-6.webp')}}" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                ...
                                <!-- <a href="{{route('wishlist')}}" class="favourite cart-item"> -->
                                    <a href="{{ route('wishlist') }}" class="favourite cart-item">Add to Wishlist</a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="{{route('product-info')}}" class="product-details">Casual Denim Jacket
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$20.99</span>
                                        <span class="new-price">$10.99</span>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img
                                    src="{{asset('frontendassets/images/homepage-one/product-img/produ')}}ct-img-13.webp"
                                    alt="product-img">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{asset('frontendassets/images/homepage-one/product-img/produ')}}ct-img-1.webp
                                    alt=" product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img
                                    src="{{asset('frontendassets/images/homepage-one/product-img/produ')}}ct-img-12.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img
                                    src="{{asset('frontendassets/images/homepage-one/product-img/produ')}}ct-img-3.webp"
                                    alt="product-img">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img
                                    src="{{asset('frontend/assets/images/homepage-one/product-img/prod')}}uct-img-6.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
