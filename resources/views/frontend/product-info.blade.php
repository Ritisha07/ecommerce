    ...
    <section class="product product-info">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span class="devider">/</span>
                <span><a href="#">{{ $product->name }} - Product Details</a></span>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content" data-aos="fade-left">
                            ...
                            <div class="ratings">
                                ...
                                <span class="text">{{ $product->reviews_count }} Reviews</span>
                            </div>
                            <div class="price">
                                <span class="price-cut">${{ $product->regular_price }}</span>
                                <span class="new-price">${{ $product->sale_price }}</span>
                            </div>
                            <p class="content-paragraph">{{ $product->description }} <span class="inner-text">the readable there content of a page.</span></p>
                            <hr>
                            <div class="product-availability">
                                <span>Availabillity : </span>
                                <span class="inner-text">{{ $product->status }}</span>
                            </div>
                            <div class="product-size">
                                ...
                                <select  >
                                    ...
                                    <option value="small">Small - 3”W x 3”D x 5”H</option>
                                    <option value="medium">Medium - 3”W x 3”D x 6”H</option>
                                    <option value="large">Large - 6”W x 3”D x 7”H</option>
                                    <option value="extra_large">Extra Large - 8”W x 4”D x 8”H</option>
                                    <option value="2xl">2XL - 10”W x 5”D x 9”H</option>
                                </select>

                                <ul class="size-option" id="sizeList">
                                    <li class="option" onclick="selectSize('Small')">
                                        <span class="option-text">Small</span>
                                        <span class="option-measure">3”W x 3”D x 5”H</span>
                                    </li>
                                    <li class="option" onclick="selectSize('Medium')">
                                        <span class="option-text">Medium</span>
                                        <span class="option-measure">3”W x 3”D x 6”H</span>
                                    </li>
                                    <li class="option" onclick="selectSize('Large')">
                                        <span class="option-text">Large</span>
                                        <span class="option-measure">6”W x 3”D x 7”H</span>
                                    </li>
                                    <li class="option" onclick="selectSize('Extra Large')">
                                        <span class="option-text">Extra Large</span>
                                        <span class="option-measure">8”W x 4”D x 8”H</span>
                                    </li>
                                    <li class="option" onclick="selectSize('2XL')">
                            ...
                            <div class="product-report">
                                <a href="route{{'#'}}" class="report" onclick="modalAction('.action')">
                                    <span>
                                    ...
                                    <div class="login-section account-section modal-main">
                                        <div class="review-form">
                                            ...
                                            <div class="login-btn text-center">
                                                <a href="route{{'#'}}" onclick="modalAction('.action')" class="shop-btn">Submit
                                                    Report</a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="product-detail-section">
                ...
                <div class="tab-content tab-item" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-seller" role="tabpanel" aria-labelledby="nav-seller-tab"
                        tabindex="0">
                        <div class="product-review-section" data-aos="fade-up">
                            <h5 class="intro-heading">seller</h5>
                            <p>This os seller tab</p>
    ...
    <section class="product weekly-sale">
        <div class="container">
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                @foreach($sellerOfTheWeekProducts as $product)
                            ...
                            <div class="ratings">
                                @for ($i = 1; $i <= 5; $i++)
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.5 0L9.18386 5.18237H14.6329L10.2245 8.38525L11.9084 13.5676L7.5 10.3647L3.09161 13.5676L4.77547 8.38525L0.367076 5.18237H5.81614L7.5 0Z" fill="{{ $product->rating >= $i ? '#FFA800' : '#D3D3D3' }}" />
                                    </svg>
                                @endfor
                            </div>
